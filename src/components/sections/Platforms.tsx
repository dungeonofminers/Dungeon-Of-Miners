    ...
    <section id="platforms" className="relative overflow-hidden py-24 sm:py-32">
      ...
      <div className="section-shell relative">
        <SectionHeading
          ...
          description="No download, no setup — mining is live right now inside the Dungeon of Miners Mini App. A dedicated Android app is next for players who want it on their home screen."
        />
